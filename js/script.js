...
popupGreetingToggle.onclick = function(){
    ...
    if(document.getElementById('greeting').value == "" && sessionStorage.getItem("userName") == null){
        document.querySelector(".popup-greeting_text").innerHTML = "Гость";
    }
    else{
        if(document.getElementById('greeting').value!=""){
            sessionStorage.setItem("userName",document.getElementById('greeting').value);
        }
        document.querySelector(".popup-greeting_text").innerHTML = sessionStorage.getItem("userName");
        document.getElementById("greeting").style.display = "none";
    }
};
...
document.getElementById("btnTrSquare").onclick = function(){
    ...
    s = 0.5 * a * h;
    if(isNaN(s)){
        document.getElementById('trSquareError').innerHTML = "Ошибка! Значения должны быть числами.";
    }
...
document.getElementById('btnStringCompare').onclick = function(){
    if(document.getElementById('String1').value.length == document.getElementById('String2').value.length){
        document.getElementById('stringCompare').innerHTML = "<span style='color: green'>true</span>";
    }
    else document.getElementById('stringCompare').innerHTML = "<span style='color: red'>false</span>";
}
...
function wrongAnswer(e){
    document.getElementById(e).innerHTML += "<span style='color: red;'>    Неверно!</span>"
...
function rightAnswer(e){
    document.getElementById(e).innerHTML += "<span style='color: green;'>    Верно!</span>"
